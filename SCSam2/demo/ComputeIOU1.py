...
if __name__ == "__main__":
    ...
    for i in range(num_objs):
        ...
        i1, u1 = ComputeIOU(mask1, mask4)
        i2, u2 = ComputeIOU(mask1, mask5)
        union1 = union1 + u1
        union2 = union2 + u2
        intersection1 = intersection1 + i1
        intersection2 = intersection2 + i2
            
    if union1 > 0 and union2 > 0:
        print(intersection1 / union1)
        print(intersection2 / union2)