import torch
from build_sam import build_sam2_video_predictor_new, build_sam2_video_predictor_spatial
from SCSam2VideoPredictorNew import SAM2VideoPredictorCustom
...
class SCSam2VideoNew:
    def __init__(self, device):
        ...
        self.predictor = build_sam2_video_predictor_new(model_cfg, sam_checkpoint, device=device)
