...
import torch
from build_scsam3 import build_scsam3_video_predictor, build_scsam3_video_predictor_newmem
...
class SCSam3Video:
    def __init__(self, device, cross_view_window=None, cross_view_hygiene=None):
        ...
        self.predictor = build_scsam3_video_predictor_newmem(
    ...
    def LoadVideo_Folder(self, folder, perms):
        ...
        for i in range(self.numImage):
            ...
            state = self.predictor_spatial.init_state(video_path = foldername, offload_video_to_cpu = True, offload_state_to_cpu = True, async_loading_frames=True)
            self.predictor_spatial.reset_state(state)
