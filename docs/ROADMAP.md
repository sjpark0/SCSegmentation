...
**최종 갱신**: 2026-09-09 (MUVOD 비교 결과: basic +10.5) · 갱신 이력은 문서 끝. 결과: [phase1-measurement.md](phase1-measurement.md) · [phase2-control.md](phase2-control.md) · [phase3-neighbourhood.md](phase3-neighbourhood.md) · **[muvod-protocol.md](muvod-protocol.md)**
...
| 채택 구성과 대조군을 c_ini에서 17개 장면 재실행 | 🔶 채택 구성 ✅ · 대조군 진행 중 | `SegMaskSam3XW1GPS4M` / `SegMaskSam3XW0M` |
