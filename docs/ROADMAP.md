...
**최종 갱신**: 2026-09-09 (MUVOD 비교 완료: +10.5 중 +10.2는 기초 모델, +0.3이 시점 결합) · 갱신 이력은 문서 끝. 결과: [phase1-measurement.md](phase1-measurement.md) · [phase2-control.md](phase2-control.md) · [phase3-neighbourhood.md](phase3-neighbourhood.md) · **[muvod-protocol.md](muvod-protocol.md)**
