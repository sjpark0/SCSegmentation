...
| P12 | 이웃 토큰 조건화 ablation | ✅ | 3 | 완료(09-08). G·P·S 절제: 4변형이 CI 조건 통과하나 상위 셋 동률 → 규칙상 손잡이 없음 유지. 헤드라인 0.8450→0.8454(S4). **정보 없는 S4가 P와 동등** ([phase3-conditioning.md](phase3-conditioning.md)) |
